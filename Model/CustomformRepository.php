...
use I95dev\Dummyproject\Api\CustomformRepositoryInterface;
use I95dev\Dummyproject\Api\Data\CustomformInterfaceFactory;
use I95dev\Dummyproject\Api\Data\CustomformSearchResultsInterfaceFactory;
use I95dev\Dummyproject\Model\ResourceModel\Customform as ResourceCustomform;
use I95dev\Dummyproject\Model\ResourceModel\Customform\CollectionFactory as CustomformCollectionFactory;
...
class CustomformRepository implements CustomformRepositoryInterface
{
    ...
    public function save(
        ...
        $customformData = $this->extensibleDataObjectConverter->toNestedArray(
            $customform,
            [],
            \I95dev\Dummyproject\Api\Data\CustomformInterface::class
        );
